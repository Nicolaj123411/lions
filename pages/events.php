	...
	<div class="event"> 
		...
		<div id="next_event">
			...
			<button class="accordion">
				<div class="flex">
				<div class="event-desc">
					<h1>Julemarkedet på Ulstrup Slot</h1>

					<h3>2. December</h3>
					<p>
						Snart åbner vi endnu engang for det årlige Julemarked på Ulstrup Slot, det er som sædvandlig den første hele weekend i december, dvs. den 2-3. december 2017. Husk at der er gratis entre og kun en lille p-afgift på 10kr
					</p>
				<ul class="info_icon">
					<i class="fa fa-wheelchair"></i>
					<i class="fa fa-coffee"></i>
...
<!-- ////////////////////////////////////////////////////////////////////// -->
			...
			<div class="accordion-content">
				<div class="event_desc_wrapper">
					...
					<p>
						Pensionist-Banko afholdes normalt den første søndag i november. Hvis du vil tilmeldes, så kan du sende en mail til ishoej@lions.dk.
					</p>
					...
					<p>
						I forbindelse med bankospillet bliver der indsamlet udtjente briller, som efter udmåling og rensning sendes til nye brugere i f.eks. Afrika. Efter alt at dømme bliver næste brilleindsamling i forbindelse med kommunal-valget den 21. november, hvor Lions Ishøj påtænker at opsætte indsamlingskasser ved de fem valgsteder i kommunen.
					</p>

					<p>
						HUSK derfor de gamle briller, når du skal stemme! Skulle du gå hen at glemme brillerne – eller har du brevstemt, så er er der alligevel mulighed for at komme af med dem, så du skal blot ringe til 70 2635 70 og aftale et tidspunkt for afhentning. PÅ FORHÅND TAK.
					</p>
...
<!-- /////////////////////////////////////////////////////////////////////////////////////////-->
			...
			<button class="accordion">
				<div class="flex">
					<div class="event-desc">
						...
						<h1>Kommunalvalgs Brilleindsamling</h1>

						<h3>20. November</h3>

						<p>
							Når du går til valgurnen ved kommunalvalget, kan du også donere dine brugte briller til Afrika. De 6 lions klubber i Randers kommune har opstillet indsamlingsbokse ved samtlige valgsteder i kommunen. Vores brilleindsamlinger plejer at være populære, fx indsamlede Lions klubberne ved EU-valget landet over mere end 16.000 par briller, og da vi ved, at valgdeltagelsen er noget højere ved kommunalvalg, håber vi på at kunne sætte en lille rekord!
						</p>
						<ul class="info_icon">
							<i class="fa fa-wheelchair"></i>
							<i class="fa fa-coffee"></i>
			...
			<div class="accordion-content">
				<div class="event_desc_wrapper">
					...
					<p>
						Når Lions deler briller ud, oplever vi stor glæde. Pludselig kan den synshæmmede se tydeligt igen. Det øger ikke kun livskvaliteten, men betyder for mange at de nu også kan arbejde igen. Specielt Afrika og Latinamerika er på modtagerlisten.Over 30.000 par briller forlader hvert år vores opmålingssted for at blive fragtet ud i den store verden. Hovedparten af disse briller er blandt andet indsamlet gennem Lions.
					</p>

					<p>
						Efter indsamling bliver brillerne sendty til opmåling hos en produktionsskole på Falster, hvor de opmåles, påsættes styrke, kontrolleres og pakkes i plastpose. Skolens elever sorterer briller, renser og måler dem op. De markeres med styrke og pakkes i kasser med 50 briller af samme styrke. Er brillerne kassable, tages glas ud, ligesom stel sorteres i metaller og plastik, hvorefter det hele sendes til genbrug. Når de defekte briller er sorteret fra, ender man op med ca. 30.000 par briller årligt, der får et nyt liv ude i verden.
					</p>

					<p>
						På modtagerstedet sørger professionelle øjenlæger eller trænede frivillige Lions/Leos for at screene de synshæmmede, så brillerne kommer til de rette brugere. Kampen mod blindhed har altid været et kerneområde i Lions, f.eks. var Lions med i udviklingen af den hvide blindestok, uddannelse af førerhunde, etablering af øjenbanker og -hospitaler i 3. verden lande m.m. Derfor er det også naturligt at syn og brilleindsamling er i fokus her i Lions 100 års jubilæumsår.
					</p>
				</div>
		</div>
</div>
