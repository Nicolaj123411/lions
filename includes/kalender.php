...
<div id="kalender_wrapper">
	...
	<div id="events_wrapper" class="flex">
				...
				<button class="accordion">
					<div class="flex">
						<div class="event-desc">
							...
							<p>
								Snart åbner vi endnu engang for det årlige Julemarked på Ulstrup Slot, det er som sædvandlig den første hele weekend i december, dvs. den 2-3. december 2017.
							</p>
						</div>
					</div>
				</button>
		...
		<div id="event_highlight">
			...
			<p>
				<?php echo $page['brød_text']; ?>
				<a href="?page=nyheder" id="event_button">Mere info</a>
			</p>
		</div>
		</div>
